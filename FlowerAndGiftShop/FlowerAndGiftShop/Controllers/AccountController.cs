...
namespace FlowerAndGiftShop.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            if (db.Customer.Where(s => s.UserID.Equals(userID)).FirstOrDefault() != null)
            {
                ViewBag.UserType = "customer";
            }
            else if (db.Employee.Where(s => s.UserID.Equals(userID)).FirstOrDefault() != null)
            {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)                
                {
                    try
                    {
                        string newUser = "customer";
                        if (model.isEmployee == "Employee")
                        {
                            newUser = "employee";
